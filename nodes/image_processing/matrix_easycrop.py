"""Compiled declaration for MATRIX_EasyCrop; regenerate instead of hand-editing."""
from __future__ import annotations

from ..._core.flow_utility import execute_compiled_node

NODE_ID = 'MATRIX_EasyCrop'
...
NODE_CLASS_MAPPINGS = {NODE_ID: MATRIXEasyCrop}
